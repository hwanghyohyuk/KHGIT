...
public class ProductController {
	...
	public void modeling(HashMap<String, Product> temp,DefaultTableModel dtm) {//Object[][]을 table의 model로 변환 
	...
	public HashMap<String, Product>  demodeling(DefaultTableModel dtm) {//Object[][]에서 HashMap로 변환
		HashMap<String, Product> temp = new HashMap<String, Product>();
		for (int i = 0; i < dtm.getRowCount(); i++) {
			Product value = new Product((String)dtm.getValueAt(i, 0), (String)dtm.getValueAt(i, 1), Integer.parseInt((String)dtm.getValueAt(i, 2)), (String)dtm.getValueAt(i, 3));
